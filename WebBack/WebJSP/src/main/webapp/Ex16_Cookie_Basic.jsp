...
<body>
   <!-- 
      ...
      1. server memory : session 객체   (사이트 접속하는 사용자마다 고유하게 부여하는 메모리(객체)) >> 서버가 리부팅, 개발코드변경 > 소멸 > 생성
    ...
    //서버에 쿠키 객체 생성
    //내 웹 서버에 접속하 브라우저(client)에게 cookie 전달(write) >> response
    
    response.addCookie(mycookie); //한 줄로 ... 
