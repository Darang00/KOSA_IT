...
<%
	...
	if(id.equals("hong")){
%>
	<%=id%><img src=images/github.png" style="width: 100px; height: 100px">
<%		
	}
%>    
<!DOCTYPE html>
...
<body>
	...
	<c:if test="${param.ID == 'hong'}"><!-- 	if(id.equals("hong")){  -->
		${param.ID}<img src="images/github.png" style="width: 100px; height: 100px">
	</c:if>
