...
<body>
	<%
		...
		out.print("getContextPath 통한 실 경로 : " + realcontextpath + "<br>");
		...
		//실 배로 경로
		//reap path : C:\KOSA_IT\Web(Back)\Labs\.metadata\.plugins\org.eclipse.wst.server.core\tmp0\wtpwebapps\WebJSP\download\note.txt
		...
		/*  
		URL : http://192.168.0.29:8090/WebJSP/Ex09_Webapp_Realpath.jsp
		URI : /WebJSP/Ex09_Webapp_Realpath.jsp
		getContextPath : CP : /WebJSP
