...
public class DosProject {
	...
	static boolean delete(File newfile) { // 파일 삭제 메소드: delete()
	...
	public static void main(String[] args) throws Exception {
		...
		System.out.println("사용법 : [java파일명] [디렉토리경로] mkdir [생성디렉토리명]"); // 파일 생성
		System.out.println("사용법 : [java파일명] [디렉토리경로] rename [파일명] [새로운 파일명]"); //이름 변경
		System.out.println("사용법 : [java파일명] [디렉토리경로] delete [파일명]"); //삭제		
		System.out.println("사용법 : [java파일명] [디렉토리경로] hidden [파일명]"); //숨김처리		
		System.out.println("사용법 : [java파일명] [디렉토리경로] dir"); // 목록 보여주기
		System.exit(0);
		}

		File f = new File(args[0]);  //args[0]의 디렉토리 주소를 File 타입의 변수에 담았다.
		...
		File newfile = new File(path);
            ...
            System.out.println(newfile + " 경로의 파일을 삭제합니다");
            delete(newfile);
			}
