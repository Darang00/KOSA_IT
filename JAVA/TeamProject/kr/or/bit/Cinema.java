...
public class Cinema {
static Scanner scanner = new Scanner(System.in);  // static 이 아니어도 된다... Cinema가 여러개이면 static 하면 공유자원으로 쓰면 되는데 Cinema 하나면 static 으로 먼저 안올려도 된다.
...
/*====================시작====================*/
	...
	void reservation () {
		...
		booking(); // booking 메소드가 "예약하기" 를 부르므로 굳이 reservation 메소드를 만들필요가 없다. 바로 booking 메소드가 하면 된다.
