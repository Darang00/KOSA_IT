...
public class Ex08_Generic_Quiz {
	...
	public static void main(String[] args) {
		//1. Array를 사용해서 TV, audio, NoteBook 을 담을 수 있는 Cart 배열을 생성하고 제품을 담으세요
		...
		//3.2 위와 동일한데 개선된 for문이 아니고 일반 for문을 사용해서 사번, 이름, 직종 출력하세요
		...
		//1. 200번 사원의 급여를 6000으로 수정하세요 (일반 for문을 통해서) getter와 setter 이용
		...
		//2. 300번 사원의 이름을 박씨에서 "궁금해씨" 수정해서 그 결과를 출력하세요 (개선된 for문)
