...
저희는 가전제품 매장 솔루션을 개발하는 사업팀
 ...
 각각의 전자제품은 다른 가격 정보를 가지고 있다.(Tv: 5000, Audio: 6000)
 제품의 포인트는 가격의 10% 적용한다
 
 시뮬레이션 시나리오
 구매자: 제품을 구매하기 위해서 금액정보, 포인트 정보를 가지고 있다.
 ex) 10만원, 포인트 0
  구매자는 제품을 구매할 수 있다. 구매행위를 하게되면 갖고 있는 돈은 차감되고 포인트는 증가한다.
  구매자는 필요에 따라서 처음 초기 금액을 가질 수 있다.
  
  1차 오픈 ....
  하와이 휴가...
  
  공식 오픈
  매장에 제품이 1000개 다른 제품이 추가(마우스, 토스트기) 제품 등록 POS (자동으로 등록)
  매장에 1000개의 제품이 전시되었다(Product를 상속하는 제품들)
  1. 매장에서 3개 제품만 구매 가능함... 나머지 997제품은 구매할 수 있는 기능이 없다.
  >> PC방 >> 국내 전산망 >> 개발 서버 접속 >> 997 구매 함수 추가...
  
  >> 변화에 대응하는 코드를 짰어야 한다.. (다형성)
  >> 즐거운 휴가를 보내기 위한 방법 제시 (제품이 10000개 추가되더라도 )
  1. 함수의 parameter를 부모타입(Product)로 한다
