/*
 ...
 재정의: 틀의 변화가 없고 (함수의 이름, 타입) 아니고 내용만 변환 {내용: 중괄호 블럭 안의 것만 수정}

 문법)
 1. 부모와 함수 이름 동일
 2. 부모 함수의 parameter도 동일
 3. 부모 함수의 return type도 동일
 4. 결국 {실행 블럭 안에 코드만 변경 가능}
...
class Point3D extends Point2 {
	...
	//@Override 컴파일러나개발툴에게 지금 이 함수가 재정의 되었는지 검증해봐 ...
