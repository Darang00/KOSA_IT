...
public class ReturnMessage {
	...
	void init() {
		...
		/*dayeong*/
		kor_message.put("0003","1:좌석현황 2:전체 회원 목록 3:회원검색 4:매출현황 5:쿠폰관리 0:로그아웃"); 
		/*dayeong*/
...
//		kor_message.put("0023","생일");
		...
		kor_message.put("0059","1:회원입퇴실내역조회  2:비밀번호 초기화  3.경고  4.정지  0:뒤로가기");//3.회원검색결과의 하위 옵션
		...
		en_message.put("0003","1:Current seats status 2:The list of entire members  3:Searching a specific member  4:Sale status  5:Coupon management  0:Log-out");
		...
		en_message.put("0054", "Managing coupon \n 1:Checking currently available coupon  2:add coupon  3:delete coupon  0:back"); //5.쿠폰관리
		...
		en_message.put("0059","1:Viewing entry/exit lsit  2:Initialize password  3.Giving caution  4.Membership suspension  0:Back");//3.회원검색결과의 하위 옵션
